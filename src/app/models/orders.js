...
var conn = mongoose.createConnection('mongodb://admin:Qwerty123@164.52.208.159:27017/superadmin?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false');
var OrdersV1Schema = new mongoose.Schema({
...
module.exports = conn.model('Orders', OrdersV1Schema);
